						...
						<div class="row">
							<div class="col-xs-6">
                              ...
                              <form id="lawexample">
								...
								<div>
								案例标题：<input type="text" id="title" name="title" style="width:307px"/>
								</div>
								</h4>
                                <h4 class="header green clearfix">
                                <div>案例类别：<select name="type" style="width:307px">
								...
								<div>
								<h4 class="header green clearfix" >
								<div >案情简介：<textarea rows="8" cols="40" id="case_des" name="case_des"> </textarea></div>
								</h4>
								<h4 class="header green clearfix">
								<div>承办过程：<textarea rows="8" cols="40" id="process" name="process"></textarea></div>
								</h4>
								<h4 class="header green clearfix">
								<div>审理结果：<textarea rows="8" cols="40" id="result" name="result"></textarea></div>
								</h4>
								</div>
								...
								<i class="icon-ok bigger-110"></i>
									...
									var $path_assets = "assets";//this will be used in loading jQuery UI if needed!
										 function add(){//发布案例
                                          var form = document.getElementById('lawexample');  
                                          var formdata = new FormData(form); 
                                            $.ajax({
												     type: "POST",
												     url: "lawexample/addLawexample.do",
												     data: formdata,
												     cache: false,
                                                     processData: false,  
                                                     contentType: false,  
